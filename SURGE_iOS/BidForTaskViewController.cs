	...
	partial class BidForTaskViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			lblSubTitle = new UILabel () {
				Text = "Submit your bid for this task",
			...
			lblBidAmountCaption = new UILabel () {
				Text = "Enter your bid",
				Font = UIFont.FromName ("Helvetica", 12f),
				Frame = new RectangleF (10, 165, w - 10, h)
			};
			txtBidAmount = new UITextField () {
				Placeholder = "$0",
				Font = UIFont.FromName ("Helvetica", 16f),
			...
			lblProvidersCaption = new UILabel () {
				Text = "Other bids for this task",
				Font = UIFont.FromName ("Helvetica", 12f),
				Frame = new RectangleF (10, 220, w - 10, h)
			};
...
//			scrollView.AddSubview(btnCancel);
		...
		bool isFormValid(){
			...
			if (txtBidAmount.Text == "") {
				msg = "Bid amount can not be empty";
			}
			if (msg != "") {
